  ...
  return (
    <div className="cauhinh-container">
      ...
      <div className="cauhinh-header">
        <h2 className="cauhinh-title">⚙️ BẢNG ĐIỀU KHIỂN: CẤU HÌNH HỆ THỐNG</h2>
        <p className="cauhinh-desc">* Khu vực đặc quyền của Admin. Mọi thay đổi tại đây sẽ ngay lập tức áp dụng cho quá trình tính toán Nhuận bút của toàn bộ Tòa soạn.</p>
      </div>
      ...
      <div className="cauhinh-card">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input type="number" name="mucChiuThue" value={formData.mucChiuThue} onChange={handleChange} className="form-input" required />
          ...
          <div className="form-group">
            ...
            <input type="number" name="phanTramThue" value={formData.phanTramThue} onChange={handleChange} className="form-input" required min="0" max="100" />
          </div>
